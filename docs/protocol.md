        # Dosehtml: Protocol Registration

        **Author:** Mahmood Ahmad, Royal Free Hospital, London, UK
        **ORCID:** 0009-0003-7781-4478
        **Registration Date:** 2026-03-28
        **Repository:** https://github.com/mahmood726-cyber/dosehtml.git

        ## Objective

        DoseHTML is a browser-based dose-response meta-analysis tool implementing flexible dose-response models for aggregate and IPD data with spline-based curve fitting.
        ...
        - Code: https://github.com/mahmood726-cyber/dosehtml.git
