...
- Replaced placeholder PDF action with full report generation in app:
  - `exportPDF()` now generates a full Methods + Results report window with print/save-as-PDF flow.
  - Embedded sections include methods, core results, coefficient table, interpretation narrative, sensitivity/subgroup/bias summaries, and figure captures when available.
